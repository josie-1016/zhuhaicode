...
public class RSAKeyPair {
    ...
    public static RSAKeyPair generate(BigInteger p, BigInteger q, BigInteger e) {
        ...
        //return new RSAKeyPair(p, q, e, true);
    }
    ...
    public RSAKeyPair(BigInteger pri, BigInteger pub, BigInteger modulus) {
        this.pri = pri;
        this.pub = pub;
        this.modulus = modulus;
    }
    ...
    protected RSAKeyPair(BigInteger p, BigInteger q, BigInteger e, boolean update, boolean delPriv) {
        ...
        //System.out.println("GENERATEGENERATEGENERATEGENERATE");
        ...
        //System.out.println("tttttttttttttttttttttttttt:" + t);
