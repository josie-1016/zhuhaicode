...
public class SM2 {
    ...
    private static byte[] ZA(String IDA, ECPoint aPublicKey) {
        ...
        byte[] ZA = sm3hash(ENTLA, idaBytes,byteConvert32Bytes(a), byteConvert32Bytes(b), byteConvert32Bytes(gx), byteConvert32Bytes(gy),
                byteConvert32Bytes(aPublicKey.getXCoord().toBigInteger()),
                byteConvert32Bytes(aPublicKey.getYCoord().toBigInteger()));
        return ZA;
    }
